 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://tempuri.org/", wsdlLocation = "file:/mnt/d/tmp/wsdl/calculator.asmx\uf03fWSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/mnt/d/tmp/wsdl/calculator.asmx\uf03fWSDL");
